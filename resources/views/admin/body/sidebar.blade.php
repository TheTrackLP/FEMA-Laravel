    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion"
        ...
        <div class="sb-sidenav-menu">
            ...
            <div class="nav">
                ...
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('borrow.*') ? 'active' : '' }}"
                    href="{{ route('borrow.list') }}">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-list"></i></div>
                    Borrowers
                </a>
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('loans.*') ? 'active' : '' }}"
                    href="{{ route('loans.dash') }}">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-users"></i></div>
                    Loan
                </a>
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('pay.*') ? 'active' : '' }}"
                    href="{{ route('pay.list') }}">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-money-bill-wave"></i></div>
                    Payments
                </a>
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('plan.*') ? 'active' : '' }}"
                    href="{{ route('plan.list') }}">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-clipboard-list"></i></div>
                    Loan Plans
                </a>
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('report') ? 'active' : '' }}"
                    href="{{ route('report')}}">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-book-open"></i></div>
                    Reports
                </a>
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('accts') ? 'active' : '' }}"
                    href="{{route('accts')}}">
                    <div class="sb-nav-link-icon"><i class="fa-solid fa-users"></i></div>
                    Staffs/Borrowers
                </a>
                <hr>
                <a class="nav-link button-hover {{ request()->routeIs('dept.*') ? 'active' : '' }}"
                    href="{{route('dept.list')}}">
